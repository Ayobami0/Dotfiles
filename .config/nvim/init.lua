...
require('lazy').setup {
  ...
  --
  --  This is equivalent to: require('Comment').setup({}) "gc" to comment visual regions/lines { 'numToStr/Comment.nvim', opts = {} }, Here is a more advanced example where we pass configuration
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<eeader>sr', builtin.resume, { desc = '[S]earch [R]esume' })
  ...
  { -- LSP Configuration & Plugins
    ...
    config = function()
      ...
      local servers = {
        ...
        pyright = {},
        bufls = {
          root_dir = require('lspconfig').util.root_pattern('.git', 'buf.work.yaml'),
        },
        -- rust_analyzer = {},
